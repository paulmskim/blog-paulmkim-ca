	...
	function wp_home_page_menu_items( $items, $args ){
                ...
                if( isset($options['wp_home_page_menu_locations'])){
                    ...
                    if( isset($options['wp_home_page_menu_locations'][$args->theme_location]) ){
                        ...
                        $label = isset($options['wp_home_page_menu_label']) ? $options['wp_home_page_menu_label'] : 'Home';
                        $title = isset($options['wp_home_page_menu_title']) ? $options['wp_home_page_menu_title'] : 'Home';
