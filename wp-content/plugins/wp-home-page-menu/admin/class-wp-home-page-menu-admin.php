...
class WP_Home_Page_Menu_Admin {
	...
	function wp_home_page_menu_admin_menu_setup(){
		add_submenu_page( 'options-general.php', 'WP Home Page Menu Settings', 'WP Home Page Menu', 'manage_options', 'wp_home_page_menu', array( $this, 'wp_home_page_menu_admin_page_screen') );
	}	
		...
		<div class="wrap">
			<form id="wp_home_page_menu_options" action="options.php" method="post">
				...
				?>
                            <div id="after-submit">
                                <p>
                                    <?php _e( "Like WP Home Page Menu?", 'wp-home-page-menu' ); ?> <a href="https://wordpress.org/support/view/plugin-reviews/wp-home-page-menu/"><?php _e( "Give us a rating", 'wp-home-page-menu' ); ?></a>
                                </p>
                                <p>
                                   <?php _e( "Need Help or Have Suggestions?", 'wp-home-page-menu' ); ?> <?php _e( "contact us on", 'wp-home-page-menu' ); ?> <a href="http://freewptp.com/forum/wordpress-plugins-forum/wp-home-page-menu/"><?php _e( "Plugin support forum", 'wp-home-page-menu' ); ?></a> <?php _e( "or", 'wp-home-page-menu' ); ?> <a href="http://freewptp.com/contact/"><?php _e( "Contact us page", 'wp-home-page-menu' ); ?></a>
                                </p>
                                <p>
                                   <?php _e( "Access Plugin Documentation on", 'wp-home-page-menu' ); ?> <a href="http://freewptp.com/plugins/wp-home-page-menu/">http://freewptp.com/plugins/wp-home-page-menu/</a>
                                </p>
                            </div>
			 </form>
		</div>
	...
	function wp_home_page_menu_settings_init(){
		...
		add_settings_section( 'wp_home_page_menu_section', 'WP Home Page Menu Settings',  array( $this, 'wp_home_page_menu_section_desc'), 'wp_home_page_menu' );

		add_settings_field( 'wp_home_page_menu_enable', 'Enable Home Page Menu : ',  array( $this, 'wp_home_page_menu_enable'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
                add_settings_field( 'wp_home_page_menu_locations', 'Choose Menu Locations : ',  array( $this, 'wp_home_page_menu_locations'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
                add_settings_field( 'wp_home_page_menu_label', 'Home Page Menu Label : ',  array( $this, 'wp_home_page_menu_label'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
                add_settings_field( 'wp_home_page_menu_title', 'Home Page Menu Title : ',  array( $this, 'wp_home_page_menu_title'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
                add_settings_field( 'wp_home_page_menu_classes', 'Home Page Menu Classes : ',  array( $this, 'wp_home_page_menu_classes'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
                add_settings_field( 'wp_home_page_menu_enable_pages_menu', 'My Site Uses Pages Menu? : ',  array( $this, 'wp_home_page_menu_enable_pages_menu'), 'wp_home_page_menu', 'wp_home_page_menu_section' );
	...
	function wp_home_page_menu_enable($args) {
	...
	function wp_home_page_menu_locations($args) {
	...
	function wp_home_page_menu_label($args) {

            $options = $this->options;
            $options['wp_home_page_menu_label'] = isset($options['wp_home_page_menu_label']) ? $options['wp_home_page_menu_label'] : 'Home';
	...
	function wp_home_page_menu_title($args) {

            $options = $this->options;
            $options['wp_home_page_menu_title'] = isset($options['wp_home_page_menu_title']) ? $options['wp_home_page_menu_title'] : 'Home';
	...
	function wp_home_page_menu_classes($args) {
	...
	function wp_home_page_menu_enable_pages_menu($args) {
